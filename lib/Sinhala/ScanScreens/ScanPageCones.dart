...
class ImagePickerPageConesSinhala extends StatefulWidget {
  @override
  _ImagePickerPageState createState() => _ImagePickerPageState();
}

class _ImagePickerPageState extends State<ImagePickerPageConesSinhala> {
  File? _image;
  ...
  Future<void> _uploadImage() async {
    ...
    final url = 'https://corn-server.onrender.com/predict?language=si';
...
void main() {
  runApp(MaterialApp(
    home: ImagePickerPageConesSinhala(),
  ));
}
